...
const LeaderboardBar = ({ data, index }) => {
	return (
		<div className="w-full p-2 flex justify-center gap-4 bg-slate-100 rounded-xl text-lg hover:shadow-lg hover:shadow-indigo-900 hover:scale-105 hover:bg-teal-300 transition-all ease-in-out">
