...
const LeaderboardBar = ({ data }) => {
	return (
		<div className="w-full p-2 flex justify-center gap-4 bg-slate-100 rounded-xl text-lg hover:shadow-lg hover:shadow-indigo-900 hover:scale-105 transition delay-75 ease-in-out hover:bg-teal-300">
