...
const MainRoom = () => {
	...
	return (
		<div className="main w-1/2 pt-24 flex flex-col justify-center items-center bg-indigo-400">
			<div className="create-room w-1/2 h-full flex flex-col justify-center items-center">
				{/* main room */}
				<div className="flex flex-col justify-center items-center gap-4 border rounded-2xl p-6 bg-slate-100/90 backdrop-blur-sm hover:shadow-xl hover:shadow-indigo-600 shadow-md shadow-indigo-800">
